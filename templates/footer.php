  ...
  <div class="social_icon">
      <ul>
          <li> <a class="en_quiry" href="" data-bs-toggle="modal" data-bs-target="#mymodal">
                  <i class="fa-solid fa-user-pen"></i>
              </a>
          </li>
          <li>
              <a class="wh_at" target="_blank" href="https://api.whatsapp.com/send?phone=+919791171024&amp;text=BRIDAL%AARI%WORK ">
                  <i class="fa-brands fa-whatsapp"></i></a>
          </li>
          <li>
              <a class="call" target="_blank" href="tel:+919080167834">
  ...
  <script type="text/javascript" class="chact">
      ...
      (function() {
          ...
          s1.async = true;
          s1.src = 'https://embed.tawk.to/647469a4ad80445890efa83d/1h1jbpb5n';
          s1.charset = 'UTF-8';
